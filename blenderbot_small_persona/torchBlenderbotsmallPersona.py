...
model.save_pretrained("./blenderbot_persona_finetuned")
tokenizer.save_pretrained("./blenderbot_persona_finetuned")
fine_tuned_model = BlenderbotSmallForConditionalGeneration.from_pretrained("./blenderbot_persona_finetuned")
fine_tuned_tokenizer = BlenderbotSmallTokenizer.from_pretrained("./blenderbot_persona_finetuned")
